...
public interface PasswordValidator
     ...
     */
    static edu.uw.tcss450.chatapp.utils.PasswordValidator checkPwdLength() {
     ...
     * @return a validator that validates the length of the String as > 6
     */
    static edu.uw.tcss450.chatapp.utils.PasswordValidator checkPwdLength(int length) {
        return password ->
     ...
     */
    static edu.uw.tcss450.chatapp.utils.PasswordValidator checkPwdDigit() {
        return password ->
     ...
     */
    static edu.uw.tcss450.chatapp.utils.PasswordValidator checkPwdUpperCase() {
        return password ->
     ...
     */
    static edu.uw.tcss450.chatapp.utils.PasswordValidator checkPwdLowerCase() {
        return password ->
     ...
     */
    static edu.uw.tcss450.chatapp.utils.PasswordValidator checkPwdSpecialChar() {
     ...
     * @return a validator that validates that the String contains a special character
     */
    static edu.uw.tcss450.chatapp.utils.PasswordValidator checkPwdSpecialChar(String specialChars) {
        return password ->
     ...
     */
    static edu.uw.tcss450.chatapp.utils.PasswordValidator checkPwdDoNotInclude(String excludeChars) {
        return password ->
     ...
     */
    static edu.uw.tcss450.chatapp.utils.PasswordValidator checkExcludeWhiteSpace() {
        return password ->
                Optional.of(!checkStringContains(password, //NOTE the !
     ...
     */
    static edu.uw.tcss450.chatapp.utils.PasswordValidator checkClientPredicate(Predicate<String> theTest) {
        return password ->
     ...
     */
    default edu.uw.tcss450.chatapp.utils.PasswordValidator and(edu.uw.tcss450.chatapp.utils.PasswordValidator other) {
...
//                .or(() -> other.apply(password));
     ...
     *      this PasswordValidator and another
     */
    default edu.uw.tcss450.chatapp.utils.PasswordValidator or(edu.uw.tcss450.chatapp.utils.PasswordValidator other) {
        return password -> this.apply(password)
                .flatMap(result -> result == ValidationResult.SUCCESS ?
